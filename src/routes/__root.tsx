...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Ateliér — Weby a propagace pro malé firmy" },
      { property: "og:description", content: "Weby na míru, propagace a vizuální identita pro menší projekty a firmy." },
